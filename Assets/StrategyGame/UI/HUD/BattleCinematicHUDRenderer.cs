...
namespace StrategyGame.UI.HUD {
   public class BattleCinematicHUDRenderer : MonoBehaviour {
      ...
      [SerializeField] private Image attackerHPFrontFill;
      [SerializeField] private Image defenderHPFrontFill;
      ...
      private void UpdateUI(bool isAttacker, int health, int maxHealth, int oldHealth, int entityID) {
         ...
         Image targetHPFrontFill = isAttacker ? attackerHPFrontFill : defenderHPFrontFill;
         Image targetLossFill = isAttacker ? attackerLossFill : defenderLossFill;
         targetLossFill.color = targetEntity.Faction == Faction.Player ? new Color(80 / 255f, 44 / 255f, 44 / 255f, 1f) : new Color(70 / 255f, 30 / 255f, 30 / 255f, 1);
         targetHPFrontFill.color = targetEntity.Faction == Faction.Player ? new Color(32 / 255f, 32 / 255f, 159 / 255f, 1f) :  new Color(159 / 255f, 32 / 255f, 32 / 255f, 1);
